...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MySignalHandler_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 50, 12)
    ...
    "MySignalHandler\0Exito\0\0handleSigHup\0"
    "handleSigTerm\0handleSigINT\0"
};
...
void MySignalHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->Exito(); break;
        case 1: _t->handleSigHup(); break;
        case 2: _t->handleSigTerm(); break;
        ...
        {
            typedef void (MySignalHandler::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MySignalHandler::Exito)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject MySignalHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MySignalHandler.data,
      qt_meta_data_MySignalHandler,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MySignalHandler.stringdata))
